...
class WeathersControllerTest < ActionController::TestCase
  ...
  test "should create weather" do
    assert_difference('Weather.count') do
      post :create, weather: { info: @weather.info, lat: @weather.lat, long: @weather.long, picture: @weather.picture, user_id: @weather.user_id }
    end
  ...
  test "should update weather" do
    patch :update, id: @weather, weather: { info: @weather.info, lat: @weather.lat, long: @weather.long, picture: @weather.picture, user_id: @weather.user_id }
    assert_redirected_to weather_path(assigns(:weather))
  end
